...
public class BanEffect {
    ...
    public BanEffect (DiceMalus diceMalus, NoPointsMalus noPointsMalus, VictoryMalus victoryMalus, PointMalus pointmalus, boolean servantsPowerMalus, boolean noFirstActionMalus, boolean noFirstActionMalus){
