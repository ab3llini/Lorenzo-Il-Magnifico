...
public class ProductionActivationController extends PlacementActionController {
    ...
    @FXML
    void onProductionActivation(MouseEvent event) {
        ...
        if (Utility.isInteger(this.additionalServantsTextField.getText())) {
            ...
            ImmediatePlacementAction action = new ImmediatePlacementAction(ImmediateBoardSectorType.Production, this.additionalServants, this.client.getUsername());
